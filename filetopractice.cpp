...
class exception_class_1 : public exception
{
public:
    exception_class_1() {}
    const char *what()
...
public:
    ExtraFeature()
    {
        // Constructor for the ExtraFeature class
        cout << "ExtraFeature: New extra feature added!" << endl;
    }

    void showFeatureInfo()
    {
        cout << "ExtraFeature: This is an extra feature." << endl;
    }

    // Other functionalities related to the extra feature can be added here
};

class Feedback : public ExtraFeature
{
...
public:
    ...
    // Other functionalities specific to feedback can be added here
};

class RateUs : public ExtraFeature
{

public:
    int rating;
    RateUs() {}
    RateUs(int rate) : rating(rate) {}

    void displayRating()
    {
        cout << "RateUs: Rating given is " << rating << " stars." << endl;
    }

    // Other functionalities specific to rating can be added here
};
